...
<body>
     ...
     <div class="navBar" id="nv">
        <nav>
            ...
            <ul>
                ...
                <li class="socialIcon"><a href="call:7634842381"><i class="bi bi-telephone-forward"></i></a></li>
                <li class="socialIcon"><a href="https://instagram.com/affy______?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"><i class="bi bi-instagram"></i></a></li>
                <li class="socialIcon"><a href="mdafzalvv@gmail.com"><i class="bi bi-envelope-fill"></i></a></li>
            </ul>
        </nav>
    </div>  
    ...
    <!-- main logo !-->
	<div class="IntroMsg">
    <img  alt="AFZAL ZAid where food meets passion" 
    class="logo" src="https://i.ibb.co/WK9hkx8/Garcia-Tavern-logos-transparent.png" id="introLogo" width="200" height="200" />
    </div>
        <!-- subject-->
	<div class='IntroMsg'>
        <h1> Yummy food, Amazing Quaility  </h1>
    </br>
        <span>
           Let us host your next special occassion
        </span>
        <h2>
       <a href="call: 7634842381" style="text-decoration: none; color: white;"> <i class="bi bi-telephone-forward-fill"> <span> Contact Me : Affy Shaikh </span></i></a>
	...
	<ul>
		...
		<li>
			...
			<span class="Price">Rs : 200 - Rs :600/span>
	...
	<ul>
		...
		<li>
			...
			<span class="Price">Rs : 180</span>
			<span class="Description"> strawberry topping.</span>
		</li>
		<li>
